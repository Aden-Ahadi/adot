...
export function FloatingWhatsApp() {
  ...
  return (
    <div className="fixed bottom-5 md:bottom-6 right-5 md:right-6 z-50">
      <button
        onClick={handleWhatsAppClick}
        onMouseEnter={() => setIsHovered(true)}
        onMouseLeave={() => setIsHovered(false)}
        className="group flex items-center gap-3 bg-green-500 hover:bg-green-600 text-white px-3 py-3 md:px-4 md:py-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
      >
        ...
        <div className="relative">
          ...
          <div className="absolute -top-1 -right-1 md:-top-1 md:-right-1 w-3 h-3 md:w-3 md:h-3 bg-white rounded-full flex items-center justify-center">
