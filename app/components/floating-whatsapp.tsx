  ...
  return (
    <div className="fixed bottom-4 md:bottom-6 right-4 md:right-6 z-50">
      <button
        ...
        className="group flex items-center gap-3 bg-green-500 hover:bg-green-600 text-white px-2 py-2 md:px-4 md:py-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
      >
